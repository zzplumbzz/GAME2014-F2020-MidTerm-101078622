 ...
 *  PlayerController.cs Script
    ...
    MODIFICATIONS:
    changed everything horizontal to be vertical and made appropriate adjustments to make it all work. and vice versa for the things that were vertical to start.
